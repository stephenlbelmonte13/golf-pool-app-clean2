    ...
    <div className="text-xs text-stone-500">
      ...
      <div className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        <div className="grid gap-4">
          <div className={panelClass}>
  <div className="p-4">
    <div className="text-lg md:text-xl font-semibold mb-3 text-stone-900">
      Pool Golfers Live Scores
    </div>

    {draftedLiveRows.length === 0 ? (
      <div className="text-sm text-stone-500">
        No golfers assigned yet.
      </div>
    ) : (
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          ...
          <tbody>
            {draftedLiveRows.map((row) => (
              ...
              >
                ...
                <td
                  className={`py-3 text-xl font-bold tabular-nums ${
                    row.toPar < 0
                      ? "text-green-700"
                      : row.toPar > 0
                      ? "text-red-700"
